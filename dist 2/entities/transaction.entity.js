...
exports.TransactionTypeEnum = exports.TransactionEntity = void 0;
...
__decorate([
    ...
    __metadata("design:type", String)
], TransactionEntity.prototype, "shareId", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
...
exports.TransactionEntity = TransactionEntity = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'transactions', schema: 'public' })
], TransactionEntity);
